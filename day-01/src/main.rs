...
static test_str: &str = "1abc2
pqr3stu8vwx
a1b2c3d4e5f
treb7uchet";

static test_2: &str = "two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
...
static real_str: &str = "fouronevhnrz44
eightg1
...
fn replace_written_digits(original: String) -> String {
    let mut replaced = original.replace("one", "o1e");
...
fn main() {
    let string: String = replace_written_digits(real_str.to_string());
    // let string = real_str;
